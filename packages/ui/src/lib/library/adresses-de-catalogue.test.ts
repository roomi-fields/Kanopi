...
// MÊME porte que mes lecteurs restants — `bpx-adapter.ts` (`homomorphism`) et
...
// le 2026-09-02 (il lit la porte des objets), ni le sac de hauteur, le registre des voix et les
// fonctions numériques depuis le 2026-09-03 (l'arbre les joint).
