...
//
// LES TERMINAUX SONT DÉCLARÉS, et le choix de `symbol` n'est pas indifférent : depuis la
...
// POURQUOI `symbol` ET NON un alphabet de notes : ce banc mesure la liste d'acteurs publiée, pas
// la musique. `symbol` déclare un nom qui existe et NE SONNE PAS — la scène reste analysable
