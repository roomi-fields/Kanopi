...
declare module 'bpscript/src/transpiler/libs-data.js' {
  // Browser bundle generated by bpscript's `libs-bundle.js` — every `lib/*.json`
  // keyed by name, with digital-function `body` sources captured from
  // `lib/digital/<fn>.ts`. The host reads `LIBS.digital` (body-full) and casts it
  // to `DigitalLib`. Opaque here (generated JS, no upstream types).
  export const LIBS: Record<string, unknown>;
}
