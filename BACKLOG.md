...
- **KAN-C20** `ouvert` — DEFAULT_BPM=128 + clampBpm[20,300] = constantes hote NON sourcees (repli affichage, hors chemin d autorite) — A SOURCER via l environnement ; lien direct point-1 defauts (BPS-defaut-env)
