...
**Intégration Kanopi:**
- `actor xxx` + `out.osc(/namespace)` consomme/produit de l'OSC nommé
...
**How to apply:** Pour ajouter un synthé à Kanopi, écrire le driver dans osc-bridge d'abord, puis `actor` + `out.osc` côté BPscript.
