...
| `contexte.transposeToken`                                                                                 | Kairos (type)                          | — (NON fourni)                                                    | absent                         | `(token, steps) => string`                                      | l'hôte ne le pose PAS : le transpose-son vit dans Kairos (KAI-10)                                              |
...
interface ContexteProjection {
  ...
  // ── posés PAR L'HÔTE (les 2 seules facettes que Kanopi assemble) ──
  pitchLib?:   PitchLib;                                               // KAI-10 — catalogues statiques
